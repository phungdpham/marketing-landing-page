...
function ClientsList() {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center -mt-44 items-end space-x-10 sm:space-x-0 sm:p-3 overflow-x-hidden">
        ...
        <div className="grid grid-cols-3 gap-10 sm:grid-cols-1 sm:gap-2">
          {[
            ...
            <div className="bg-white shadow p-5 w-[400px] sm:w-auto border h-[350px] sm:h-auto">
              <div className="flex space-x-10 sm:space-x-0 items-center justify-between sm:flex-col">
                ...
                <h1 className="text-primary font-semibond text-2xl">
                  {item.name}
                </h1>
              </div>
              <p className="text-gray-500 text-md- mt-10">{item.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="flex space-x-2">
          {[1, 2, 3, 4].map((item, index) => (
            <div
              ...
              className={`bg-gray-300 h-4 w-4 rounded-full cursor-pointer hover:scale-105 transition-all duration-300 ${
