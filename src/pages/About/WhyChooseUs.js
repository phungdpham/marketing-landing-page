...
function WhyChooseUs() {
  ...
  return <div className='mx-32 sm:mx-3 mt-20 border shadow'>
    ...
    {items.map((item) => (
        <div className='p-5 bg-white border shadow flex flex-col space-y-5 items-center transform hover:scale-105 duration-200'>
